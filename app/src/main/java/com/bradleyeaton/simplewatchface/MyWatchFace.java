...
//            mSecondPaint.setShadowLayer(SHADOW_RADIUS, 0, 0, mWatchHandShadowColor);
            ...
            mSmallTickAndCirclePaint.setColor(mSmallTickColor);
            mSmallTickAndCirclePaint.setStrokeWidth(SECOND_TICK_STROKE_WIDTH);
...
//            mSmallTickAndCirclePaint.setShadowLayer(SHADOW_RADIUS, 0, 0, mWatchHandShadowColor);
            ...
            mBigTickPaint.setColor(mBigTickColor);
...
//            int day = mCalendar.get(Calendar.DAY_OF_MONTH);
//            String output = mCalendar.getDisplayName(Calendar.DATE,Calendar.ALL_STYLES, Locale.ENGLISH);
...
//            System.out.println(output);
        ...
        private void drawWatchFace(Canvas canvas) {
            ...
            if(hours == 0 && minutes < 3){
                //for first 3 minutes of day check to change the date
                updateDate();
            }
            float dateX = mCenterX;
            float dateY = mCenterY + (0.5f * mCenterY);
            canvas.drawText(dateRep, dateX, dateY, mTextPaint);

            //draw battery percentage
            float batteryTextX = mCenterX;
...
//            oval.set(mCenterX, mCenterY - radius, mCenterX);
        ...
        private void registerReceiver() {
            ...
            if(!isRegisteredBatteryInfo){
                ...
                MyWatchFace.this.registerReceiver(mBatteryInfo, filter);
            }
